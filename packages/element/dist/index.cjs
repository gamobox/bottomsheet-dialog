"use strict";var c=Object.defineProperty;var h=Object.getOwnPropertyDescriptor;var g=Object.getOwnPropertyNames;var u=Object.prototype.hasOwnProperty;var b=(s,t)=>{for(var e in t)c(s,e,{get:t[e],enumerable:!0})},v=(s,t,e,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of g(t))!u.call(s,a)&&a!==e&&c(s,a,{get:()=>t[a],enumerable:!(o=h(t,a))||o.enumerable});return s};var m=s=>v(c({},"__esModule",{value:!0}),s);var f={};b(f,{BsButton:()=>n,BsDialog:()=>d});module.exports=m(f);var p=require("@bottomsheet-dialog/core"),n=class extends HTMLElement{state;unsubscribe;constructor(){super(),this.attachShadow({mode:"open"}),this.state=new p.ToggleState;let t=document.createElement("style");t.textContent=`
      button {
        padding: 0.5rem 1rem;
        font-family: inherit;
        font-weight: 500;
